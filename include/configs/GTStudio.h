...
/* input clock of PLL */
#define CONFIG_SYS_CLK_FREQ		12000000/* the GT2440 has 12MHz input clock */
...
#define CS8900_BUS16            1 /* the Linux driver does accesses as shorts */#endif
#endif
...
/* enable GTStudio Logo	*/
#define CONFIG_GTSTUDIO_LOGO		1
...
/* 用户自定义LCD型号 */
//#define LCD_TFT			PT035		/* INNOLUX 3.5"LCD */
#define LCD_TFT				WD_F3224WI	/* WINTEK  3.5"LCD */
//#define LCD_TFT			TX11D		/* HITACHI  4.3"LCD */
//#define LCD_TFT			A070		/* INNOLUX 7.0"LCD */

#if(LCD_TFT == PT035)
#define CONFIG_LCD_VBPD                11
#define CONFIG_LCD_VFPD                5
#define CONFIG_LCD_VSPW                5
#define CONFIG_LCD_HBPD                69
#define CONFIG_LCD_HFPD                10
...
#elif(LCD_TFT == A070)
#define	CONFIG_LCD_VBPD		25
#define	CONFIG_LCD_VFPD		5
#define	CONFIG_LCD_VSPW		1
#define	CONFIG_LCD_HBPD		67
...
#define	CFG_PROMPT			"GTStudio> "	/* Monitor Command Prompt	*/
